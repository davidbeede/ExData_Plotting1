...
#replicates plot 4 of programming assingment 1
...
with(tabFeb2007HPC, plot(newDateTime, Voltage, type = "l",
        ylab = "Voltage", xlab = "datetime", 
        font.lab = 2, cex.lab = 0.8, font.axis = 2, 
        cex.axis = 0.8))

with(tabFeb2007HPC, plot(newDateTime, Global_reactive_power, type = "l",
